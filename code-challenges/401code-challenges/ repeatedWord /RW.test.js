...
describe('Repeated Word Test', () => {
  ...
  it('should return error message when everything is unique', ()=>{
    expect(repeatedWord('Once upon a time, there was...')).toBe('No Repeated Word');
  });

  it('Edge Case: should return error message when passing not str', ()=>{
    expect(repeatedWord(5)).toBe('this function work just with string only');
  });
